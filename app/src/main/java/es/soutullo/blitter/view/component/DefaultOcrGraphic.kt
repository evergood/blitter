...
class DefaultOcrGraphic internal constructor(
    overlay: GraphicOverlay<OcrGraphic>,
    private val bounding: Rect
) : OcrGraphic(overlay, null) {
    override fun contains(x: Float, y: Float): Boolean =
        bounding.left < x && bounding.right > x && bounding.top < y && bounding.bottom > y
